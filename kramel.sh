...
# Files/artifacts
FILES=Image.gz
DTB="$KERNEL_DIR"/out/arch/arm64/boot/dts/qcom/sdmmagpie.dtb
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/NetErnels/AnyKernel3.git -b phoenix
	msg "|| Cloning libufdt ||"
...
gen_zip() {
	...
	mv $DTBO_IMG AnyKernel3/dtbo.img
	if [ $BUILD_DTBO = 1 ]
	then
